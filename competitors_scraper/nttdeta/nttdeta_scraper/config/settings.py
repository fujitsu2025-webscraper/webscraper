...
# スクレイピング対象のURL
TARGET_URL = "https://www.nttdata.com/jp/ja/trends/data-insight/cases/"
...
以下のカテゴリから、与えられた事例に最も適したものを1つ選んでください：
...
SUMMARY_SYSTEM_MESSAGE = """あなたは優秀な要約生成AIです。
与えられたテキストを200-300文字程度の簡潔な要約にしてください。
要約は事例の主要なポイント、課題、解決策、成果を含めてください。
専門用語はそのまま使用し、具体的な数字（成果や効果）があれば必ず含めてください。
